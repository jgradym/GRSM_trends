...
topo = st_read("/Users/jgradym/Downloads/GRSM_100K_TOPO_BOUNDARIES.geojson")
boundary = st_read("/Users/jgradym/Downloads/GRSM_100K_TOPO_BOUNDARIES.geojson")
boundary = st_read("/Users/jgradym/Downloads/GRSM_100K_TOPO_BOUNDARIES/GRSM_100K_TOPO_BOUNDARIES.shp")
plot(boundary[10])
...
plot(sf::st_geometry(pts_first_sf), add = TRUE, pch = 16, cex = 0.9, col = "#1f78b4")

# # (optional) labels:
# text(pts_first$LON, pts_first$LAT, labels = pts_first$StreamName, pos = 4, cex = 0.7)
